# AWS IoT Device SDK Embedded C as Microservice

## Overview

This repository is an open-source project that runs "AWS IOT Device SDK Embedded C (https://github.com/aws/aws-iot-device-sdk-embedded-C.git | SHA : da99638)" as 
- `isolated`
- `access-controlled` (Resource and Credential)
- `individually-deployable`
- `plug&play`
Microservices that can be downloaded and run with a one-click from Microservice Store.


> <b>IMPORTANT</b>: This is a proxy account, where ideally the open-source library vendor shall maintain this repository.

> <b>IMPORTANT</b> As it is a proxy effort, Microservice Store does not guarantee the quality of the open-source library, but "embedded Mircoservice Runtime(eMR)" isolates and controls the access right, and in case of any malfunctioning in the library, eMR quarantines the vendor library and report to the product vendors who uses this library.
